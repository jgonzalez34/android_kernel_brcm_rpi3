...
EXPORT_SYMBOL(bme280_read_uncomp_temperature);
/*!
...
EXPORT_SYMBOL(bme280_compensate_temperature_int32);
/*!
 * @brief Reads actual temperature from uncompensated temperature
...
EXPORT_SYMBOL(bme280_read_uncomp_pressure);
/*!
...
EXPORT_SYMBOL(bme280_read_uncomp_humidity);
/*!
...
EXPORT_SYMBOL(bme280_compensate_humidity_int32);
/*!
 * @brief Reads actual humidity from uncompensated humidity
...
EXPORT_SYMBOL(bme280_get_oversamp_temperature);
...
EXPORT_SYMBOL(bme280_set_oversamp_temperature);
/*!
 *	@brief This API is used to get
...
EXPORT_SYMBOL(bme280_get_oversamp_pressure);
/*!
 *	@brief This API is used to set
 *	the pressure oversampling setting in the register 0xF4
 *	bits from 2 to 4
...
EXPORT_SYMBOL(bme280_set_oversamp_pressure);
/*!
 *	@brief This API is used to get
...
EXPORT_SYMBOL(bme280_get_oversamp_humidity);
/*!
 *	@brief This API is used to set
 *	the humidity oversampling setting in the register 0xF2
 *	bits from 0 to 2
...
EXPORT_SYMBOL(bme280_set_oversamp_humidity);
/*!
...
EXPORT_SYMBOL(bme280_get_power_mode);
/*!
...
EXPORT_SYMBOL(bme280_set_power_mode);
/*!
...
EXPORT_SYMBOL(bme280_get_filter);
...
EXPORT_SYMBOL(bme280_set_filter);
/*!
...
EXPORT_SYMBOL(bme280_get_standby_durn);
/*!
...
EXPORT_SYMBOL(bme280_set_standby_durn);
/*
...
EXPORT_SYMBOL(bme280_read_register);
...
EXPORT_SYMBOL(bme280_compensate_pressure_int64);
/*!
 * @brief Reads actual pressure from uncompensated pressure
...
EXPORT_SYMBOL(bme280_compute_wait_time);
